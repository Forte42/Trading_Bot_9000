...
df2 = pd.read_sql(f'SELECT * FROM fear_greed;', conn)
df2.rename(columns = {'pct_change':'Actual_Returns'}, inplace = True)
df2.rename(columns = {'classification_int':'Encoded_Class'}, inplace = True)
df2 = df2.drop(columns='Change')
