def get_binance_btc_1m_data():

	""" Gets trade by trade data from Binance and writes it to 'binance_btc_1m' table in MySQL crypto DB """
	...
	try:
		...
		print('Successfully acquired last timestamp from binance_btc_1m')
